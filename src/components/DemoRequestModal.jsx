...
const businessTypes = [
  ...
  { id: "retail", label: "Retail & Store", icon: "🏬", tag: "POS Ready" },
      ...
      >
        ...
        {!submitted ? (
          <>
            ...
            <div className="space-y-1.5 relative z-10 pr-9 sm:pr-8">
              ...
              <p className="text-xs sm:text-sm text-slate-600 font-sans font-medium leading-relaxed">
                Experience sub-300ms offline POS billing, automated WhatsApp ledger, and audit-grade GST filing.
              </p>
            </div>

            {/* Modern Interactive Form */}
            <form onSubmit={handleSubmit} className="space-y-3.5 relative z-10 font-sans">
              <div className="space-y-3">
                
                {/* Full Name & WhatsApp Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                  <div className="space-y-1">
                    <label className="block text-[10px] sm:text-[11px] font-mono-tech font-bold uppercase tracking-wider text-slate-700">
                      Your Full Name *
                    </label>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative flex items-center">
                      <Phone className="w-4 h-4 text-emerald-500 absolute left-3 pointer-events-none" />
                      <input
                        type="tel"
                        required
                ...
                {/* Interactive Category Chips with Responsive 2-Col Grid */}
                <div className="space-y-1.5 pt-0.5">
                  <div className="flex items-center justify-between">
                    <label className="block text-[10px] sm:text-[11px] font-mono-tech font-bold uppercase tracking-wider text-slate-700">
                      Select Business Category
                    </label>
                    <span className="text-[9px] sm:text-[10px] font-mono-tech text-blue-600 font-bold">
                      Customized UI
                    </span>
                  </div>
                    ...
                    {businessTypes.map((type) => {
                      ...
                      return (
                        <button
                          ...
                          className={`group px-2 sm:px-3 py-2 sm:py-2.5 rounded-xl text-xs font-semibold flex items-center justify-between gap-1 cursor-pointer transition-all duration-200 w-full ${
                            isSelected
                        ...
                        >
                          <div className="flex items-center gap-1.5 min-w-0 truncate">
                            <span className="text-xs sm:text-sm shrink-0">{type.icon}</span>
                            <span className="truncate text-[10px] sm:text-xs font-sans">{type.label}</span>
                          </div>
                          <span
                            className={`hidden md:inline-block text-[9px] px-1.5 py-0.5 rounded-md font-mono-tech shrink-0 ${
                              isSelected
              ...
              <button
                type="submit"
                className="w-full py-3 sm:py-3.5 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 hover:from-blue-500 hover:to-indigo-500 text-white font-display font-bold text-xs sm:text-sm tracking-wide shadow-lg shadow-blue-500/30 flex items-center justify-center gap-2 cursor-pointer transition-all hover:scale-[1.01] active:scale-[0.98] mt-2"
              >
              ...
              {/* Trust Badges */}
              <div className="pt-1 flex flex-wrap items-center justify-center gap-x-3.5 sm:gap-x-4 gap-y-1 text-[10px] sm:text-[11px] font-mono-tech text-slate-500">
          ...
          <div className="py-6 sm:py-8 text-center space-y-4 relative z-10">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-emerald-50 border-2 border-emerald-200 text-emerald-600 flex items-center justify-center mx-auto shadow-lg shadow-emerald-500/15">
            ...
            <button
              ...
              className="px-6 sm:px-8 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-full text-xs sm:text-sm font-bold transition-all shadow-md cursor-pointer hover:scale-105 active:scale-95"
            >
              Back to Website
            </button>
          </div>
